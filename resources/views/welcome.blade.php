		          ...
		          <tr>
		            <td class="bg_light email-section">
		            	<div class="heading-section" style="text-align: center; padding: 0 30px;">
            				...
            				<p style="color: black; font-family:Comic Sans MS;">				<br><br> Welcome to the Birthday Notification Back End </p>
		              	<center><img src="{{env('DOMAIN')}}/images/birthdayNotification.png" style="background-size: cover; height: auto; max-width: 100%; display: block;"></center>
		            	</div>
